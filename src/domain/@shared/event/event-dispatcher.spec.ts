...
import SendLogConsoleWhenCustomerChangeAddressHandler from "../../customer/event/handler/send-log-console-when-customer-change-address.handler";
import SendLog1ConsoleWhenCustomerIsCreatedHandler from "../../customer/event/handler/send-log1-console-when-customer-is-created.handler";
import SendLog2ConsoleWhenCustomerIsCreatedHandler from "../../customer/event/handler/send-log2-console-when-customer-is-created.handler";
